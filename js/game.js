...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const TutorialSystem = {
        ...
        steps: [
            ...
            {
                title: "你的玩家資料與資源狀態",
                text: "<p style='margin-bottom: 15px;'>頂部狀態欄分為兩個部分：</p><ul style='text-align: left; padding-left: 25px; margin: 10px 0 15px 0;'><li><strong>左側：</strong>玩家資料（顯示你的頭像和名稱）</li><li><strong>右側：</strong>遊戲資源</li></ul><p style='margin-bottom: 10px;'>遊戲資源包含：</p><ul style='text-align: left; padding-left: 25px; margin: 10px 0 15px 0;'><li><img src='assets/images/蜂蜜幣.png' style='width: 20px; height: 20px; vertical-align: middle; margin-right: 5px;'> <strong>蜂蜜幣</strong>：主要貨幣，用於進貨和日常開銷</li><li><img src='assets/images/顧客滿意度.png' style='width: 20px; height: 20px; vertical-align: middle; margin-right: 5px;'> <strong>顧客滿意度</strong>：反映出消費者在體驗產品與服務後的整體感受，屬於短期效益</li><li><img src='assets/images/聲望.png' style='width: 20px; height: 20px; vertical-align: middle; margin-right: 5px;'> <strong>聲望</strong>：建立良好聲望需要長期累積正面互動，每一次的選擇都息息相關</li></ul><p style='margin-top: 15px; font-weight: bold; color: #8b4513;'><img src='assets/images/2.png' style='width: 20px; height: 20px; vertical-align: middle; margin-right: 5px;'> 提示：點擊玩家資料可進入設定，妥善管理資源是成功的關鍵！</p>",
                highlight: ".header",
                position: "bottom"
            },
            {
            ...
            {
                title: "遊戲主視窗",
                text: "<p style='margin-bottom: 15px;'>這裡是遊戲的核心操作區域，<br>會根據你的操作顯示：</p><ul style='text-align: left; padding-left: 25px; margin: 10px 0;'><li>地區選擇界面</li><li>進貨管理界面</li><li>劇情故事</li><li>隨機事件和選項</li><li>財務報表結果</li></ul><p style='margin-top: 15px; font-weight: bold; text-align: center;'>所有重要的決策都在這裡進行！</p>",
